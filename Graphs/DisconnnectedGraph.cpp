// BFSprint_graph && DFSprint_graph are good only for connected graphs, but not for disconnected ones
#include <bits/stdc++.h>
using namespace std;

void printDFS(int **edges, int n, int sv, bool *visited) // sv stands for starting vertex,assuming sv = 0
{
    cout << sv << " ";
    visited[sv] = true;
    for (int i = 0; i < n; i++)
